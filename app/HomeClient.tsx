          ...
          <AnimatedSection delay={0.2}>
            <div className="relative flex justify-center">
              ...
              <img
                ...
                fetchPriority="high"
                src={CDN.product}
                alt="仙佛護持・避邪淨化隨身噴霧產品外觀 - AUS LIFE"
  ...
  return (
    <div className="relative py-20 md:py-28 overflow-hidden">
      <div className="absolute inset-0">
        <img loading="lazy" aria-hidden="true" src={CDN.shield} alt="" className="w-full h-full object-cover opacity-20" />
    ...
    <footer className="border-t border-[oklch(1_0_0/6%)] py-10" style={{ background: "oklch(0.08 0.01 150)" }}>
      <div className="container text-center">
        ...
        <div className="mt-8 pt-8 border-t border-[oklch(1_0_0/6%)] space-y-2 text-[oklch(0.7_0.04_85)]">
          ...
          <p className="text-base md:text-lg">
            <span className="text-[oklch(0.55_0.02_85)]">📞 可打電話來訂購｜</span>
            <a
