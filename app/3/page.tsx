...
const productJsonLd = {
  ...
  offers: {
    "@type": "Offer",
    url: "https://www.auslife.com.tw/products/仙佛護持-避邪淨化隨身噴霧",
    priceCurrency: "TWD",
    price: "880",
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text:
          "您可以透過本頁面的「立即購買」按鈕前往官方商城選購，單瓶售價 NT$880。目前購買 2 瓶即享免運優惠，也可以透過 LINE 官方帳號諮詢客服了解更多組合方案。",
      },
    },
    {
      "@type": "Question",
