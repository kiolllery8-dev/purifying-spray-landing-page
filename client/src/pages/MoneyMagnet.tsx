      ...
      <section className="mm-verse">
        <div className="mm-verse-inner mm-verse-layout">
          ...
          <div className="mm-img-slot mm-teacher">
            <img src={CDN.masterXuankong} alt="塔羅老師 玄空 · 命理專業肖像" />
          </div>
      ...
      <section className="mm-quote-band">
        <div className="mm-quote-inner">
          <div className="mm-img-slot mm-master-lg">
            <img src={CDN.masterWang} alt="王玄真 大師 · 命理／芳療專業肖像" />
          </div>
        ...
        <div className="mm-flow-list">
          {[
            ...
            <div className="mm-flow-step" key={step.num}>
              ...
              <div className="mm-flow-image"><img src={step.img} alt={step.zh} /></div>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="mm-ing-rows">
          ...
          <div className="mm-ing-row">
            ...
            <div>
              ...
              <div className="mm-ing-plant-photo"><img src={CDN.plantVetiver} alt="岩蘭草 · 土生金 · 能量視覺" /></div>
          ...
          <div className="mm-ing-row">
            ...
            <div>
              ...
              <div className="mm-ing-plant-photo"><img src={CDN.plantOrange} alt="甜橙 · 陽光金幣 · 能量視覺" /></div>
              <div className="mm-ing-lore">
          ...
          <div className="mm-ing-row">
            ...
            <div>
              ...
              <div className="mm-ing-plant-photo"><img src={CDN.plantBasil} alt="甜羅勒 · 君王守財 · 能量視覺" /></div>
              <div className="mm-ing-lore">
          ...
          <div className="mm-ing-row">
            ...
            <div>
              ...
              <div className="mm-ing-plant-photo"><img src={CDN.plantPatchouli} alt="廣藿香 · 四方來財 · 能量視覺" /></div>
              <div className="mm-ing-lore">
            ...
            <div className="mm-testi-card" key={i}>
              ...
              <div className="mm-testi-foot">
                <div className="mm-testi-avatar-wrap">
                  <div className="mm-avatar-sm"><img src={t.avatar} alt={t.name} /></div>
                  <div>
              ...
              <div className="mm-testi-scene"><img src={t.scene} alt={`${t.name} 場景`} /></div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mm-ritual mm-section">
        <div className="mm-ritual-header">
          ...
          <div className="mm-ritual-product">
            <img src={CDN.product} alt="發財噴霧 10ml" />
        ...
        <div className="mm-ritual-grid">
          ...
          <div className="mm-ritual-card">
            ...
            <div className="mm-ritual-scene"><img src={CDN.ritualMorning} alt="清晨店面 · 噴霧淨化空間" /></div>
          </div>
          {/* 02 */}
          <div className="mm-ritual-card">
            ...
            <div className="mm-ritual-scene"><img src={CDN.ritualWallet} alt="皮夾 · 名片 · 存摺 · 噴霧" /></div>
          </div>
          {/* 03 */}
          <div className="mm-ritual-card">
            ...
            <div className="mm-ritual-scene"><img src={CDN.ritualMeeting} alt="面試 · 簽約 · 衣物噴霧氣場" /></div>
          </div>
        </div>
      </section>
